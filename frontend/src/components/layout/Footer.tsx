            ...
            <div className="container mx-auto px-6 py-16">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <Link href="/" className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-xl font-bold">
                                pdf<span className="text-indigo-400">hustle</span>
                            </span>
                        </Link>
                        <p className="text-gray-400 max-w-md mb-6">
                            Smooth, fast, and minimal online PDF tools. Edit, convert, and hustle with your PDFs - all in your browser, no sign-up required.
                        </p>
                ...
                <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-gray-500 text-sm">
                        © {currentYear} pdfhustle. All rights reserved.
                    </p>
                    <p className="text-gray-500 text-sm">
